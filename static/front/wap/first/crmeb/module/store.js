(function(global,factory){
    ...
    return {
        ...
        getCasesList:function(p,successCallback,errorCallback){
            this.baseGet($h.U({
                m:'m',
                c:'Ajax',
                a:'caseList.php?data=',
        ...
        boutiqueCase:function(p,successCallback,errorCallback){
            this.baseGet($h.U({
                m:'m',
                c:'Ajax',
                a:'case_viewList.php?data=',
                p:p
            }),successCallback,errorCallback);
        },
        boutiqueNews:function(p,successCallback,errorCallback){
            this.baseGet($h.U({
                m:'m',
                c:'Ajax',
                a:'article_viewList.php?data=',
                p:p
            }),successCallback,errorCallback);
        },
        commonProblem:function(successCallback,errorCallback){
            this.baseGet($h.U({
                m:'m',
                c:'Ajax',
                a:'commonProblem.php',
        ...
        industrys:function(successCallback,errorCallback){
            this.baseGet($h.U({
                m:'m',
                c:'Ajax',
                a:'M_industrys.php',
        ...
        newsHeader:function(successCallback,errorCallback){
            this.baseGet($h.U({
                m:'m',
                c:'Ajax',
                a:'newsHeader.php',
        ...
        getnewsList:function(p,successCallback,errorCallback){
            this.baseGet($h.U({
                m:'m',
                c:'Ajax',
                a:'newsList.php?data=',
        ...
        customerUpload:function(data,successCallback,errorCallback){
            this.basePost($h.U({
                m:'mobile',
                c:'auth_api',
                a:'customerUpload',
        ...
        querys:function(data,successCallback,errorCallback){
            this.basePost($h.U({
                m:'m',
                c:'Ajax',
                a:'querys1.php',
        ...
        generatePic:function(data,successCallback,errorCallback){
            this.basePost($h.U({
                m:'mobile',
                c:'auth_api',
                a:'generatePic',
        ...
        applicationAuthorization:function(data,successCallback,errorCallback){
            this.basePost($h.U({
                m:'m',
                c:'Ajax',
                a:'applicationAuthorization.php',
            }),data,successCallback,errorCallback)
        },
        ...
        homeDataList: function(successCallback,errorCallback){
            this.baseGet($h.U({
                m:'m',
                c:'Ajax',
                a:'homeDataList.php',
        ...
        customizedMobilePic: function(successCallback,errorCallback){
            this.baseGet($h.U({
                m:'mobile',
                c:'auth_api',
                a:'customizedMobilePic',
            }),successCallback,errorCallback);
        },
